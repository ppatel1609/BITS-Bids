...
import com.artgallery.dao.AddressDao;
import com.artgallery.dao.OtpVerificationDao;
import com.artgallery.dao.UserDao;
import com.artgallery.dto.AddUserRequest;
import com.artgallery.dto.AddWalletMoneyRequestDto;
import com.artgallery.dto.CommanApiResponse;
import com.artgallery.dto.UserLoginRequest;
import com.artgallery.dto.UserRegistrationResponse;
import com.artgallery.dto.UserVerifyRegisterRequest;
...
import com.artgallery.utility.ResponseCode;
...
public class UserController {
	...
	public ResponseEntity<?> registerUser(@RequestBody AddUserRequest userRequest) {
		...
		String subject = "BITSBids - Verify Your Email Address for User Registration";
		String message = "User Registration OTP for BITSBids Website: " + otp + ". Please keep it confidential.";
	...
	@GetMapping("profile/fetch")
	public ResponseEntity<String> getProfile(@RequestParam("userId") int userId)
	{
		User user = userDao.findById(userId).get();
		System.out.println("PROF");
		return new ResponseEntity<>(String.valueOf(user.getEmailId()),HttpStatus.OK);
	}
}
